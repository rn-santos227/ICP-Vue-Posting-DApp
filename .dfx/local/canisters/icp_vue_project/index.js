...
import { idlFactory } from './icp_vue_project.did.js';
export { idlFactory } from './icp_vue_project.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ICP_VUE_PROJECT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_vue_project.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_vue_project canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_vue_project.did.js")._SERVICE>}
 */
export const icp_vue_project = createActor(canisterId);
